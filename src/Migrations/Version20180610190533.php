 ...
 */
final class Version20180610190533 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_preference (id INT AUTO_INCREMENT NOT NULL, date_time_format_id INT DEFAULT NULL, timezone VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_FA0E76BF4B243A98 (date_time_format_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE page_snapshot (id INT AUTO_INCREMENT NOT NULL, page_id INT NOT NULL, project_snapshot_id INT DEFAULT NULL, body LONGTEXT DEFAULT NULL, headers LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:LONGTEXT_array)\', hash VARCHAR(255) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, response_code INT NOT NULL, response_time DOUBLE PRECISION DEFAULT NULL, timestamp BIGINT NOT NULL, INDEX IDX_ACD21215C4663E4 (page_id), INDEX IDX_ACD21215B3F6CEA5 (project_snapshot_id), FULLTEXT INDEX IDX_ACD21215DBA80BB2 (body), FULLTEXT INDEX IDX_ACD21215F7034F85 (headers), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE job_queue (id INT AUTO_INCREMENT NOT NULL, page_id INT NOT NULL, UNIQUE INDEX UNIQ_7EA1C213C4663E4 (page_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE job_queue DROP FOREIGN KEY FK_7EA1C213C4663E4');
