 ...
 */
final class Version20180625155503 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE page CHANGE name name VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
