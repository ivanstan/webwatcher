 ...
 */
final class Version20180823065426 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE action_group (id INT AUTO_INCREMENT NOT NULL, resource_id INT NOT NULL, name VARCHAR(255) DEFAULT NULL, INDEX IDX_8A0E887989329D25 (resource_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
